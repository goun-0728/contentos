...
export const NAMED_BLOCKS = [
  ...
  { key: 'subCopy',  label: '서브', x: 40, y: 220, w: 780, fontSize: 28, color: 'rgba(255,255,255,0.85)', fontWeight: 400 },
  { key: 'bodyText', label: '내용', x: 40, y: 370, w: 780, fontSize: 20, color: 'rgba(255,255,255,0.72)', fontWeight: 400 },
]
